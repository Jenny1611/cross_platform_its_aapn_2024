...
class _$NameApiModelImpl with DiagnosticableTreeMixin implements _NameApiModel {
  const _$NameApiModelImpl({required this.common, required this.official});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'NameApiModel(common: $common, official: $official)';
  }
...
abstract class _NameApiModel implements NameApiModel {
  const factory _NameApiModel(
      {required final String common,
      required final String official}) = _$NameApiModelImpl;
